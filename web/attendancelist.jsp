...
<html>
<head>
    <title>Admin | TMS Attendance List</title>
    <style type="text/css">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/list_attendance">AttendanceList</a> <span class="divider"></span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row placeholders">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-md-1 control-label">
                            <a href="<%=request.getContextPath()%>/new_attendance" class="btn btn-success">Add New Attendance</a>
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        <li><a href="<%=request.getContextPath()%>/new_attendance" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="New">+</a></li>
                        <li><a href="<%=request.getContextPath()%>/list_attendance" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View">*</a></li>
                    </ul>
                </div>


                <form action="list_attendance" method="post" class="form-horizontal">
                    <div class="row">
                        <div class="col-md-10 form-group has-success">
                            <Label Class="col-md-2 control-label">* Search Attendance </Label>
                            <div class="col-md-3">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach var="attendance" items="${listAttendance}">
                            <tr>
                                ...
                                <td><c:out value="${attendance.getFirstName()}" /></td>
                                <td><c:out value="${attendance.getAttendDate()}" /></td>
                                <td><c:out value="${attendance.getCheck_IN()}" /></td>
                                <td><c:out value="${attendance.getCheck_OUT()}" /></td>
                                <td><c:out value="${attendance.getComment()}" /></td>
                                <td>
                                    <a href="edit_attendance?Attendance_id=<c:out value='${attendance.getAttendance_id()}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="delete_attendance?Attendance_id=<c:out value='${attendance.getAttendance_id()}' />">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
