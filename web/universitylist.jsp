...
<html>
<head>
    <title>Admin | TMS University List</title>
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row">
                <div class="col-md-4 col-xs-4">
                    <div class="page-heading">
                        <h3 style="color:#0269A4">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Admin / University List
                        </h3>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/list_university">UniversityList</a> <span class="divider"></span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row placeholders">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-md-1 control-label">
                            <a href="<%=request.getContextPath()%>/new_university" class="btn btn-success">Add New University</a>
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        <li><a href="<%=request.getContextPath()%>/new_university" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="New">+</a></li>
                        <li><a href="<%=request.getContextPath()%>/list_university" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View">*</a></li>
                    </ul>
                </div>


                <form action="list_university" method="post" class="form-horizontal">
                    <div class="row">
                        <div class="col-md-10 form-group has-success">
                            <Label Class="col-md-2 control-label">* Search University Name</Label>
                            <div class="col-md-3">
                                <input  type="text" ID="SearchUniversity" placeholder="Search By University Name" class="form-control" name="SearchUniversity">
                            </div>
                            <label class="col-md-1 control-label">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach var="university" items="${listUniversity}">
                            ...
                            <tr>
                                ...
                                <td><c:out value="${university.getUniversityName()}" /></td>
                                <td>
                                    <a href="edit_university?University_id=<c:out value='${university.getUniversity_id()}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="delete_university?University_id=<c:out value='${university.getUniversity_id()}' />">Delete</a>
