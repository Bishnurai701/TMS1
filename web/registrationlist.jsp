...
<html>
<head>
    <title>Admin | TMS Registration List</title>
    <style type="text/css">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row">
                <div class="col-md-4 col-xs-4">
                    <div class="page-heading">
                        <h3 style="color:#0269A4">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Admin / Registration List
                        </h3>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/list_registration">RegistrationList</a> <span class="divider"></span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row placeholders">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-md-1 control-label">
                            <a href="<%=request.getContextPath()%>/new_registration" class="btn btn-success">Add New Registration</a>
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        <li><a href="<%=request.getContextPath()%>/new_registration" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="New">+</a></li>
                        <li><a href="<%=request.getContextPath()%>/list_registration" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View">*</a></li>
                    </ul>
                </div>


                <form action="list_registration" method="post" class="form-horizontal">
                    <div class="row">
                        <div class="col-md-10 form-group has-success">
                            <Label Class="col-md-2 control-label">* Search Person Name</Label>
                            <div class="col-md-3">
                                <input  type="text" ID="SearchPerson" placeholder="Search By Person Name" class="form-control" name="SearchPerson">
                            </div>
                            <label class="col-md-1 control-label">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach var="registration" items="${listRegistration}">
                            <tr>
                                <td> <c:out value="${registration.getRegistration_id()}" /></td>
                                <td><c:out value="${registration.getRegistrationDate()}" /></td>
                                <td><c:out value="${registration.getFirstName()}" /></td>
                                <td><c:out value="${registration.getGender()}" /></td>
                                <td><c:out value="${registration.getDOB()}" /></td>
                                <td><c:out value="${registration.getPersonalIDNumber()}" /></td>
                                <td><c:out value="${registration.getPostName()}" /></td>
                                <td><c:out value="${registration.getSectionName()}" /></td>
                                <td><c:out value="${registration.getDepartmentName()}" /></td>
                                <td><c:out value="${registration.getEmail()}" /></td>
                                <td><c:out value="${registration.getMobileNo()}" /></td>
                                <td>
                                    <a href="edit_registration?Registration_id=<c:out value='${registration.getRegistration_id()}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="delete_registration?Registration_id=<c:out value='${registration.getRegistration_id()}' />">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
