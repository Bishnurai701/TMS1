...
<html>
<head>
    <title>Admin | TMS Add Department</title>
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div class="col-md-4 col-xs-4">
                    <div class="page-heading">
                        <h3 style="color:#0269A4">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Admin / New Department
                        </h3>
                    </div>
                </div>
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/list_department">Departments</a> <span class="divider"></span></li>
            ...
            <div class="row placeholders">
                ...
                <c:if test="${department != null}">
                <form action="update_department" method="post" class="form-horizontal">
                    </c:if>

                    <c:if test="${department == null}">
                    <form action="insert_department" method="post" class="form-horizontal" name="myform">
                        </c:if>
                        ...
                        <div class="form-group" style="color:#0269A4">
                            <div class="col-md-5">
                                <caption>
                                    <h4>
                                        <c:if test="${department != null}">
                                            <label class="control-label"><span class="glyphicon glyphicon-user"></span>  Edit Department </label>
                                        </c:if>
                                        <c:if test="${department == null}">
                                            <label class="control-label"><span class="glyphicon glyphicon-user"></span>  Add New Department </label>
                                        </c:if>
                                    </h4>
                                </caption>
                            </div>
                        ...
                        <c:if test="${department == null}">
                            ...
                            <input type="hidden" name="Department_id" value="<c:out value='${department.Department_id}' />"/>
                            <hr>
                            ...
                            <div class="form-group" style="color:#0269A4">
                                ...
                                <div class="col-md-3  has-success">
                                    ...
                                    <input type="text"  value="<c:out value='${department.DepartmentName}' />" class="form-control " name="DepartmentName" placeholder="Enter Department Name..." >
                        ...
                        <!-- --------------------------update form----------------------------    -->
                        <c:if test="${department != null}">
                            <input type="hidden" name="Department_id" value="<c:out value='${department.getDepartment_id()}' />"/>
                            ...
                            <div class="form-group has-success" style="color:#0269A4">
                                <label class="col-md-2 control-label">Department Name: </label>
                                <div class="col-md-3">
                                    <input type="text" value="<c:out value='${department.getDepartmentName()}' />" class="form-control" name="DepartmentName" placeholder="Enter Department Name...">
                                </div>
                            </div>
