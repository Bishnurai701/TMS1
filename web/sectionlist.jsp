...
<html>
<head>
    <title>Admin | TMS Section List</title>
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row">
                <div class="col-md-4 col-xs-4">
                    <div class="page-heading">
                        <h3 style="color:#0269A4">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Admin / Section List
                        </h3>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/list_section">SectionList</a> <span class="divider"></span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row placeholders">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-md-1 control-label">
                            <a href="<%=request.getContextPath()%>/new_section" class="btn btn-success">Add New Section</a>
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        <li><a href="<%=request.getContextPath()%>/new_section" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="New">+</a></li>
                        <li><a href="<%=request.getContextPath()%>/list_section" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View">*</a></li>
                    </ul>
                </div>


                <form action="list_section" method="post" class="form-horizontal">
                    <div class="row">
                        <div class="col-md-10 form-group has-success">
                            <Label Class="col-md-2 control-label">* Search Section Name</Label>
                            <div class="col-md-3">
                                <input  type="text" ID="SearchSection" placeholder="Search By Section Name" class="form-control" name="SearchSection">
                            </div>
                            <label class="col-md-1 control-label">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach var="section" items="${listSection}">
                            ...
                            <tr>
                                ...
                                <td><c:out value="${section.getSectionName()}" /></td>
                                <td>
                                    <a href="edit_section?Section_id=<c:out value='${section.getSection_id()}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="delete_section?Section_id=<c:out value='${section.getSection_id()}' />">Delete</a>
