...
<html>
<head>
    <title>Admin | TMS Add University</title>
    <style type="text/css">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div class="col-md-4 col-xs-4">
                    <div class="page-heading">
                        <h3 style="color:#0269A4">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Admin / New University
                        </h3>
                    </div>
                </div>
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/list_university">University</a> <span class="divider"></span></li>
            ...
            <div class="row placeholders">
                ...
                <c:if test="${university != null}">
                <form action="update_university" method="post" class="form-horizontal">
                    </c:if>

                    <c:if test="${university == null}">
                    <form action="insert_university" method="post" class="form-horizontal" name="myform">
                        </c:if>
                        ...
                        <div class="form-group" style="color:#0269A4">
                            <div class="col-md-5">
                                <caption>
                                    <h4>
                                        <c:if test="${university != null}">
                                            <label class="control-label"><span class="glyphicon glyphicon-user"></span>  Edit University </label>
                                        </c:if>
                                        <c:if test="${university == null}">
                                            <label class="control-label"><span class="glyphicon glyphicon-user"></span>  Add New University </label>
                                        </c:if>
                                    </h4>
                                </caption>
                            </div>
                        ...
                        <c:if test="${university == null}">
                            ...
                            <input type="hidden" name="University_id" value="<c:out value='${university.University_id}' />"/>
                            <hr>
                            ...
                            <div class="form-group" style="color:#0269A4">
                                ...
                                <div class="col-md-3  has-success">
                                    ...
                                    <input type="text"  value="<c:out value='${university.UniversityName}' />" class="form-control " name="UniversityName" placeholder="Enter University Name..." >
                        ...
                        <!-- --------------------------update form----------------------------    -->
                        <c:if test="${university != null}">
                            <input type="hidden" name="University_id" value="<c:out value='${university.getUniversity_id()}' />"/>
                            ...
                            <div class="form-group has-success" style="color:#0269A4">
                                <label class="col-md-2 control-label">University Name: </label>
                                <div class="col-md-3">
                                    <input type="text" value="<c:out value='${university.getUniversityName()}' />" class="form-control" name="UniversityName" placeholder="Enter University Name...">
                                </div>
                            </div>
