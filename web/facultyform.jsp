...
<html>
<head>
    <title>Admin | TMS Add Faculty</title>
    <style type="text/css">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div class="col-md-4 col-xs-4">
                    <div class="page-heading">
                        <h3 style="color:#0269A4">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Admin / New Faculty
                        </h3>
                    </div>
                </div>
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/list_faculty">Faculty</a> <span class="divider"></span></li>
            ...
            <div class="row placeholders">
                ...
                <c:if test="${faculty != null}">
                <form action="update_faculty" method="post" class="form-horizontal">
                    </c:if>

                    <c:if test="${faculty == null}">
                    <form action="insert_faculty" method="post" class="form-horizontal" name="myform">
                        </c:if>
                        ...
                        <div class="form-group" style="color:#0269A4">
                            <div class="col-md-5">
                                <caption>
                                    <h4>
                                        <c:if test="${faculty != null}">
                                            <label class="control-label"><span class="glyphicon glyphicon-user"></span>  Edit Faculty </label>
                                        </c:if>
                                        <c:if test="${faculty == null}">
                                            <label class="control-label"><span class="glyphicon glyphicon-user"></span>  Add New Faculty </label>
                                        </c:if>
                                    </h4>
                                </caption>
                            </div>
                        ...
                        <c:if test="${faculty == null}">
                            ...
                            <input type="hidden" name="Faculty_id" value="<c:out value='${faculty.Faculty_id}' />"/>
                            <hr>

                            <div class="form-group" style="color:#0269A4">
                                <label class="col-md-2 control-label">Faculty Name: </label>
                                <div class="col-md-3  has-success">

                                    <input type="text"  value="<c:out value='${faculty.FacultyName}' />" class="form-control " name="FacultyName" placeholder="Enter Faculty Name..." >
                        ...
                        <!-- --------------------------update form----------------------------    -->
                        <c:if test="${faculty != null}">
                            <input type="hidden" name="Faculty_id" value="<c:out value='${faculty.getFaculty_id()}' />"/>
                            ...
                            <div class="form-group has-success" style="color:#0269A4">
                                <label class="col-md-2 control-label">Faculty Name: </label>
                                <div class="col-md-3">
                                    <input type="text" value="<c:out value='${faculty.getFacultyName()}' />" class="form-control" name="FacultyName" placeholder="Enter Faculty Name...">
                                </div>
                            </div>
