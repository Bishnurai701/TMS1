            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/listgroup">GroupList</a> <span class="divider"></span></li>
            ...
            <div class="row placeholders">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-md-1 control-label">
                            <a href="<%=request.getContextPath()%>/newgroup" class="btn btn-success pull-left">New UseGroup</a>
                        </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        <li><a href="<%=request.getContextPath()%>/newgroup" class="btn btn-primary">+</a></li>
                        <li><a href="<%=request.getContextPath()%>/listgroup" class="btn btn-primary">*</a></li>
                    </ul>
                </div>
                <form action="listgroup" method="post" class="form-horizontal">
                <div class="row">
                    <div class="col-md-10 form-group has-success">
                        <Label Class="col-md-2 control-laber">* User Group Name</Label>
                        <div class="col-md-3">
                            <input  type="text" ID="SearchUserGroup" placeholder="Search By User Group" class="form-control" name="SearchUserGroup"></input>
                        </div>
                        <label class="col-md-1 control-label">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="usergroup" items="${listUserGroup}">
                        <tr>
                            <td><c:out value="${usergroup.getUserGroup_id()}" /></td>
                            <td><c:out value="${usergroup.getUserGroupName()}" /></td>

                            <td>
                                <a href="editgroup?UserGroup_id=<c:out value='${usergroup.getUserGroup_id()}' />"><i class="fa fa-edit"></i> Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="deletegroup?UserGroup_id=<c:out value='${usergroup.getUserGroup_id()}' />"><i class="fa fa-archive"> Delete</i></a>
