...
<html>
<head>
    <title>Admin | TMS Qualification List</title>
    <style type="text/css">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row">
                <div class="col-md-4 col-xs-4">
                    <div class="page-heading">
                        <h3 style="color:#0269A4">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Admin / Qualification List
                        </h3>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        ...
                        <li class="active"><a href="<%=request.getContextPath()%>/list_qualification">QualificationList</a> <span class="divider"></span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row placeholders">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-md-1 control-label">
                            <a href="<%=request.getContextPath()%>/new_qualification" class="btn btn-success">Add New Qualification</a>
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb breadcrumb-modified pull-right" style="background-color: transparent;">
                        <li><a href="<%=request.getContextPath()%>/new_qualification" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="New">+</a></li>
                        <li><a href="<%=request.getContextPath()%>/list_qualification" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View">*</a></li>
                    </ul>
                </div>


                <form action="list_qualification" method="post" class="form-horizontal">
                    <div class="row">
                        <div class="col-md-10 form-group has-success">
                            <Label Class="col-md-2 control-label">* Search Qualification</Label>
                            <div class="col-md-3">
                                <input  type="text" ID="SearchQualification" placeholder="Search By Qualification Name" class="form-control" name="SearchQualification">
                            </div>
                            <label class="col-md-1 control-label">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <c:forEach var="qualification" items="${listQualification}">
                            <tr>
                                <td> <c:out value="${qualification.getQualification_id()}" /></td>
                                <td><c:out value="${qualification.getFirstName()}" /></td>
                                <td><c:out value="${qualification.getLevelName()}" /></td>
                                <td><c:out value="${qualification.getInstituteName()}" /></td>
                                <td><c:out value="${qualification.getPercentOrGPA()}" /></td>
                                <td><c:out value="${qualification.getPassedYear()}" /></td>
                                <td><c:out value="${qualification.getAddress()}" /></td>
                                <td><c:out value="${qualification.getBoardName()}" /></td>
                                <td><c:out value="${qualification.getFacultyName()}" /></td>
                                <td><c:out value="${qualification.getUniversityName()}" /></td>
                                <td>
                                    <a href="edit_qualification?Qualification_id=<c:out value='${qualification.getQualification_id()}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="delete_qualification?Qualification_id=<c:out value='${qualification.getQualification_id()}' />">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
