    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div class="col-md-4 col-xs-4">
                    <div class="page-heading">
                        <h3 style="color:#0269A4">
                            <span class="glyphicon glyphicon-user"></span> &nbsp; Admin / New Municipality
                        </h3>
                    </div>
                </div>
                <div class="col-md-8">
            ...
            <div class="row placeholders">
                ...
                <c:if test="${municipality != null}">
                <form action="update_municipality" method="post" class="form-horizontal">
                    </c:if>

                    <c:if test="${municipality == null}">
                    <form action="insert_municipality" method="post" class="form-horizontal" name="myform">
                        </c:if>
